...
startup
{
    ...
    // Main full game settings
    settings.Add("ruins", true, "Ruins (Full Game)");
    ...
    vars.goals = new Dictionary<string, object[]>()
    {
        ...
        // Item Acquisition
        {"iu-duck",    new object[] {false, -1, -1, -1,  99, -1, 100}},
        {"iu-ribbon",  new object[] {false, -1, -1, -1,  22, -1, 101}},
        {"iu-fullinv", new object[] {false, -1, -1, -1,  -1, -1, 102}},
        {"iu-quiche",  new object[] {false, -1, -1, -1,  89, -1, 103}},
        {"iu-temmie",  new object[] {false, -1, -1, -1, 315, -1, 104}},
        
        // Other
        {"o-lesserdog", new object[] {false, 106, -1, -1,  -1, 24, 105}},
        {"o-temmie",    new object[] {false,  -1, -1, -1, 315, -1, 106}},
        {"o-die",       new object[] {false,  -1, -1, -1,  -1, -1, 107}},
...
init
{
    ...
    if(version != "Unknown" && version != "DEMO")
    {
        ...
        Func<int, string, IntPtr> scan = (o, sig) =>
        {
            ...
            if(ptr == IntPtr.Zero)
                throw new NullReferenceException("[UNDERTALE CE] Signature scanning failed");
    ...
    current.kills = 0;
    current.room = 0;
    vars.log("Found version " + version + " | debug: " + (vars.isDebugMode ? "yes" : "no") + " process " + game.Id + " | module size " + module.ModuleMemorySize + " | data.win hash " + hash);
}
